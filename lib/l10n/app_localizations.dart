...
abstract class AppLocalizations {
  ...
  /// No description provided for @numberOfAllowedTrainers.
  ///
  /// In en, this message translates to:
  /// **'Allowed Trainers'**
  String get numberOfAllowedTrainers;

  /// No description provided for @numberOfAllowedCoaches.
  ///
  /// In en, this message translates to:
  /// **'Allowed Coaches'**
  String get numberOfAllowedCoaches;
